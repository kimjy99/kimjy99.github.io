---
title: "[RL공부] 1. Exact Dynamic Programming (Bertsekas, MIT)"
last_modified_at: 2023-02-13
categories:
  - 공부
tags:
  - Reinforcement Learning
excerpt: "Reinforcement Learning and Optimal Control 책으로 RL 공부한 내용 정리"
use_math: true
classes: wide
---
...
이 책의 가장 중요한 점은 Dynamic Programming (DP) 관점에서 강화학습을 다룬다는 것이다. 
...
$(x_k, u_k)$의 Q-factor를 가음과 같이 정의한다. 
...
$$
\begin{equation}
J_\pi (x_0) = \mathbb{E}_{x_k, w_k} \bigg[ g_N (x_N) + \sum_{k=0}^{N-1} g_k (x_k, \mu_k (x_k), w_k) \bigg]
\end{equation}
$$
...
<br>
(* 책에서는 $\mathbb{E}_{x_k, w_k}$ 대신 $E$로 표현)
...
$$
\begin{equation}
Q_k^\ast (x_k, u_k) = \mathbb{E}_{x_k, u_k} \bigg[ g_k (x_k, u_k, w_k) + J_{k+1}^\ast (f_k (x_k, u_k, w_k)) \bigg]
\end{equation}
$$
...
$$
\begin{aligned}
Q_k^\ast (x_k, u_k) =& \mathbb{E}_{x_k, u_k} \bigg[ g_k (x_k, u_k, w_k) \\
