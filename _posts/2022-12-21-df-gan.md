---
layout: post
title: "[논문읽기/GAN] DF-GAN: A Simple and Effective Baseline for Text-to-Image Synthesis"
feature-img: "assets/img/df-gan/df-gan-title.png"
---
...
<center><img src='{{"/assets/img/df-gan/df-gan-osb.PNG" | relative_url}}' width="60%"></center>
...
## DF-GAN 구조
<center><img src='{{"/assets/img/df-gan/df-gan-structure.PNG" | relative_url}}' width="60%"></center>
...
($z$는 noise vector, $e$는 sentence vector, $\mathbb{P}_g$, $\mathbb{P}_r$, $\mathbb{P}_{mis}$는 생성된 데이터, 실제 데이터, mismatch 데이터의 분포)
...
<center><img src='{{"/assets/img/df-gan/df-gan-ma-gp.PNG" | relative_url}}' width="60%"></center>
...
### 3. One-Way Output
<center><img src='{{"/assets/img/df-gan/df-gan-owo.PNG" | relative_url}}' width="60%"></center>
...
<center><img src='{{"/assets/img/df-gan/df-gan-dfblock.PNG" | relative_url}}' width="60%"></center>
...
- Adam(betas = 0, 0.9), lr_g = 1e-4, lr_d = 4e-4, TTUR
- Evaluation: 256x256 이미지 30,000장 (text는 랜덤)에 대한 IS, FID
- COCO dataset은  IS가 평가지표로 부적절하여 제외
- NoP (number of parameters)도 평가

### Examples
<center><img src='{{"/assets/img/df-gan/df-gan-example.PNG" | relative_url}}' width="60%"></center>

### Results
<center><img src='{{"/assets/img/df-gan/df-gan-table1.PNG" | relative_url}}' width="60%"></center>

### Ablation study
<center><img src='{{"/assets/img/df-gan/df-gan-table2.PNG" | relative_url}}' width="60%"></center>
<center><img src='{{"/assets/img/df-gan/df-gan-table3.PNG" | relative_url}}' width="60%"></center>
