...
<center><img src='{{"/assets/img/depth-pro/depth-pro-fig1.PNG" | relative_url}}' width="100%"></center>
...
## Method
### 1. Network
<center><img src='{{"/assets/img/depth-pro/depth-pro-fig3.PNG" | relative_url}}' width="100%"></center>
<br>
...
<center><img src='{{"/assets/img/depth-pro/depth-pro-fig2.PNG" | relative_url}}' width="55%"></center>
<br>
다음은 zero-shot metric depth 정확도를 비교한 결과이다. 

<center><img src='{{"/assets/img/depth-pro/depth-pro-table1.PNG" | relative_url}}' width="100%"></center>
<br>
다음은 zero-shot 경계 정확도를 비교한 결과이다. 

<center><img src='{{"/assets/img/depth-pro/depth-pro-table2.PNG" | relative_url}}' width="100%"></center>
<br>
다음은 생성된 depth map을 novel view synthesis 시스템인 [TMPI](https://arxiv.org/abs/2309.14291)에 적용한 결과를 비교한 것이다. 

<center><img src='{{"/assets/img/depth-pro/depth-pro-fig4.PNG" | relative_url}}' width="90%"></center>
<br>
다음은 초점 거리 추정 결과를 비교한 것이다. $$\delta_\textrm{25%}$$와 $$\delta_\textrm{50%}$$는 초점 거리의 상대 오차가 각각 25%와 50%보다 작은 이미지의 비율(%)이다. 

<center><img src='{{"/assets/img/depth-pro/depth-pro-table3.PNG" | relative_url}}' width="100%"></center>