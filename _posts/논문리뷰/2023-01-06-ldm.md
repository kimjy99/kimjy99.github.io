---
title: "[논문리뷰/Diffusion] High-Resolution Image Synthesis with Latent Diffusion Models (LDM)"
...
tags:
  ...
  - Computer Vision
  - AI
excerpt: "Latent Diffusion Models 논문 리뷰"
use_math: true
classes: wide
---

> arxiv: <https://arxiv.org/pdf/2112.10752.pdf>  
...
$\tau_\theta$와 $\epsilon_\theta$는 위 식으로 동시에 최적화된다. 각 도메인별 기존 모델들에 의해 $\tau_\theta$이 파라미터화할 수 있기 떄문에 이 conditioning 메커니즘은 유연하다. 
...
다음은 ImageNet-Val. LDM-SR의 ImageNet에 대한 64→256 super-resolution 결과이다. 
