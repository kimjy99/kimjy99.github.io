---
title: "[논문리뷰/Diffusion] Classifier-Free Diffusion Guidance"
...
tags:
  ...
  - Computer Vision
  - AI
excerpt: "Classifier-Free Diffusion Guidance 논문 리뷰"
use_math: true
classes: wide
---
...
## Introduction
Diffusion Models Beat GANs on Image Synthesis 논문에서는 추가 classifier를 학습하여 샘플의 품질의 향상시키는 **classifier guidance**가 제안되었다. Classifier guidance는 diffusion model의 score 추정치와 classifier의 로그 확률의 입력 기울기를 혼합한다. Classifier gradient의 강도를 변경하여 Inception Score (IS)와 FID (또는 precision과 recall)를 절충할 수 있다. 
