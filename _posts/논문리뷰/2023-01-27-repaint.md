---
title: "[논문리뷰/Diffusion] RePaint: Inpainting using Denoising Diffusion Probabilistic Models"
...
$$
\begin{aligned}
x_{t-1}^\textrm{known} & \sim \mathcal{N} (\sqrt{\overline{\alpha}_t} x_0, (1-\overline{\alpha}_t)I) \\
