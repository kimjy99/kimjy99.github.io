...
> arXiv 2024. [[Paper](https://arxiv.org/abs/2401.16663)] [[Page](https://yingjiang96.github.io/VR-GS/)]  
...
#### Inpainting
3D-GS segmentation 후 장면에서 모든 물체를 추출한다. 그러나 이러한 물체 제거 과정으로 인해 이전에 막혔던 영역 내에 구멍이 생긴다. 문제를 완화하기 위해 우리는 2D 인페인팅 도구 [LaMa](https://arxiv.org/abs/2109.07161)를 활용하여 Gaussian의 3D 인페인팅을 가이드한다. 구멍 외부에 있는 Gaussian을 고정한 다음 inpainting loss
