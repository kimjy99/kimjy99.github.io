...
두 픽셀 $p_1$, $p_2$ 사이의 feature correspondences $$\mathbf{S}_\mathbb{I} (p_1, p_2)$$는 렌더링된 feature 사이의 코사인 유사도로 정의된다.

$$
\begin{equation}
\mathbb{S}_\mathbb{I} (p_1, p_2) = \langle \mathbf{F}_{\mathbf{I}, p_1}^r, \mathbf{F}_{\mathbf{I}, p_2}^r \rangle
\end{equation}
$$
