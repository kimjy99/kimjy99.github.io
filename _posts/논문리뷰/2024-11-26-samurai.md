...
<center><img src='{{"/assets/img/samurai/samurai-fig1.PNG" | relative_url}}' width="100%"></center>
<br>
...
## Method
<center><img src='{{"/assets/img/samurai/samurai-fig2.PNG" | relative_url}}' width="100%"></center>
<br>
...
<center><img src='{{"/assets/img/samurai/samurai-fig3.PNG" | relative_url}}' width="80%"></center>
<br>
다음은 SAMURAI와 기존 VOT 방법들의 AUC(%)를 LaSOT, LaSOT<sub>ext</sub>, GOT-10k 데이터셋에서 비교한 표이다. 

<center><img src='{{"/assets/img/samurai/samurai-table1.PNG" | relative_url}}' width="100%"></center>
<br>
다음은 SAMURAI와 기존 VOT 방법들의 AUC(%)를 TrackingNet, NFS, OTB100 데이터셋에서 비교한 표이다. 

<center><img src='{{"/assets/img/samurai/samurai-table2.PNG" | relative_url}}' width="42%"></center>

### 2. Ablation Studies
다음은 (왼쪽) 제안된 모듈들과 (오른쪽) 모션 가중치 $$\alpha_\textrm{kf}$$에 대한 ablation 결과이다. 

<div style="display: flex; align-items: start; justify-content: center">
  <img src='{{"/assets/img/samurai/samurai-table3.PNG" | relative_url}}' width="38.5%">
  &nbsp;
  <img src='{{"/assets/img/samurai/samurai-table4.PNG" | relative_url}}' width="28.5%">
</div>
<br>
다음은 VOT에 대하여 SAM 기반 tracking 방법과 SAMURAI를 비교한 표이다. 

<center><img src='{{"/assets/img/samurai/samurai-table5.PNG" | relative_url}}' width="85%"></center>
<br>
다음은 동영상 속성에 따른 AUC(%)를 분석한 표이다. 

<center><img src='{{"/assets/img/samurai/samurai-table6.PNG" | relative_url}}' width="100%"></center>

### 3. Qualitative Results
다음은 SAMURAI와 기존 방법들의 tracking 결과를 시각화한 것이다. 

<center><img src='{{"/assets/img/samurai/samurai-fig4.PNG" | relative_url}}' width="100%"></center>