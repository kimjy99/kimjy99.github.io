---
title: "[논문리뷰/Diffusion] Grad-TTS: A Diffusion Probabilistic Model for Text-to-Speech"
...
이다. 무한한 시간을 생각했을 때 $e^{-\int_0^\infty \beta_s ds} = 0$인 임의의 nosie schedule $\beta_t$에 대하여 $Law (X_t \vert X_0)$는 $\mathcal{N}(\mu, \Sigma)$로 수렴한다. 
