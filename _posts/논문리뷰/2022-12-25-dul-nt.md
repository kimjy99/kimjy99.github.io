---
title: "[논문리뷰/Diffusion] Deep Unsupervised Learning using Nonequilibrium Thermodynamics"
...
tags:
  ...
  - Computer Vision
  - AI
excerpt: "Deep Unsupervised Learning using Nonequilibrium Thermodynamics 논문 리뷰"
use_math: true
classes: wide
---

> arxiv: <https://arxiv.org/pdf/1503.03585.pdf>  
> Github: <https://github.com/Sohl-Dickstein/Diffusion-Probabilistic-Models>
...
<br>
(a)는 원본 bark 이미지, (b)는 원본에 100x100 가우시안 noise를 대체한 이미지, (c)는 (b)에서 모델로 sampling한 이미지

## Appendix

<details>
<summary> Lower Bound 유도 </summary>
