...
\textrm{where} \quad \mathcal{U} = \{ \textbf{M} \in \mathbb{R}_{\ge 0}^{K^2 \times K^2} : \textbf{M} \textbf{1} = \frac{\textbf{1}}{K^2}, \textbf{M}^\top \textbf{1} = \textbf{1} / K^2 \}, \quad H (\textbf{M}) = - \sum_{ij} M_{ij} \log M_{ij}
\end{equation}
$$
